  ...
  return (
    <AnimePageWrapper title={'About'} id="About">
      <div>
        ...
        <p className={styles.aboutText}>
          Dexola formed a strategic partnership with Trinetix Group. While our
          own certified development and design teams focus on blockchain,
          Trinetix gives us access to more than 800 professionals in other areas
          of development, design, legal, and operations. As part of this
        ...
        <p className={styles.aboutText}>
          ...
          user interface design, with over a quarter of the workforce dedicated
          to UX/UI. Dexola clients can also benefit from this pool of talent,
